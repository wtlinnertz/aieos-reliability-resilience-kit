...
> **Synchronized copy.** The canonical version of this file is `aieos-spec/governance-model.md`.
> Do not edit this file directly — update the canonical version first, then sync all kit copies.
> Kit copies must never diverge from the canonical version.
