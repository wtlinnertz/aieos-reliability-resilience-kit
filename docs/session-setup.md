...
Use this file to set up an AI session for each RRK artifact. Find the section for the artifact you're generating or validating. Follow the checklist before starting.
